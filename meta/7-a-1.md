...
indicator_definition: >-
  ...
  여기서 자금이란, 외국 정부 및 다국적 기관으로부터 청정 에너지 연구 개발 및 재생에너지 생산을 목적으로 ODA 수원국 DAC 리스트(개발원조위원회 목록)의 나라로부터 받는 모든 공식 대출, 보조금 및 지분 투자로 정의됨. DAC 채권자 보고 시스템(CRS)상의 다음과 같은 섹터 코드를 포함함
  23210 에너지 생성, 재생 가능 소스
  23220 수력 발전소
  23230 태양 에너지
  23240 풍력 에너지
  23250 해양 에너지
