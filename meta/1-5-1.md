...
indicator_definition: >- 
  인구 10만 명당 사망, 실종, 재해의 직접적 피해를 받은 사람의 수를 의미함. 직접적 피해란 부상, 질병 또는 기타 건강상의 영향을 받은 
  사람을 의미하며, 대피, 피난, 이주를 경험했거나 생계, 경제적, 물리적, 사회적, 문화적 및 환경적 자산에 직접적인 피해를 입은 사람들을 
  포함함. 지표 값인 X는 국가 재난 손실 데이터베이스의 지표(사망, 실종자, 영향자)를 전 세계 인구데이터(국가 인구조사, 세계은행, 
  유엔 통계위원회 정보)로 나눈 단순식으로 계산함. 
