...
indicator_name: >-
  장애학생들에게 적합하게 마련된 시설과 교육자료 접근성이 있는 학교의 비율(교육수준별) / 
  식수 접근 가능한 학교 비율 (교육수준별) / 교육목적의 인터넷 접근성 가능한 학교 비율(교육수준별) / 
  성별 위생시설의 접근이 가능한 학교 비율(교육수준별)/ 교육목적의 컴퓨터 접근이 가능한 학교 비율(교육수준별)/ 
  전기가 보급되는 학교비율(교육수준별) / 손씻기 시설이 비치된 학교 비율(교육수준별) / 
