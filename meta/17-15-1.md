...
indicator_definition: >-
  모든 관련된 개발 파트너가 국가 주도 결과 프레임워크(country-led results frameworks: CRFs)를 사용하여 개발 협력 노력을 계획하고 성과를 평가하는 방법과 정도를 측정. 개발협력 공여국이 국가의 개발 우선 순위와 목표를 반영하는 국가 정부 주도 결과 프레임워크로부터 가져온 목표 및 결과 지표를 바탕으로 개입을 설계하는 정도를 평가
