...
indicator_definition: >-
  ...
  공공 조달 정책 정도를 지수화하기 위해서 아래 5가지 주요 내용이 필요함.
  ① 관련 업무 관계자의 지속가능한 공공 조달 정책에 대한 헌신, ② 지속가능한 공공 조달 정책 실행을 위해 공무원 교육과 역량강화, ③ 지속가능한 공공 조달 정책을 실질적으로 수행하기 위핸 지원, ④ 지속가능한 공공 조달 정책 모니터링 시스템, ⑤ 지속가능한 공공 조달 정책 선택 기준과 우선순위
