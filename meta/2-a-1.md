...
indicator_definition: >-
  정부지출 중 농업지출 비율과 GDP 중 농업부가가치 비율의 비(ratio)로 계산한 지수. 농업지향지수(AOI)가 1보다 크면 정부의 농업지출이 농업의 국내생산 기여보다 상대적으로 크다는 것을 의미하고, 1보다 작으면 정부의 농업지출이 농업의 국내생산 기여보다 상대적으로 작다는 것을 의미
